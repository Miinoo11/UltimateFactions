...
public class FactionAdapter_v1_10_R1 extends FactionsAdapter {

    @Override
    public AnvilUI createAnvilUI(Player player) {
        return new AnvilGUI_v1_10_R1(player);
    }
    ...
    public void sendActionBarTitle(Player player, String msg) {
        net.minecraft.server.v1_10_R1.PacketPlayOutChat packet = new net.minecraft.server.v1_10_R1.PacketPlayOutChat(net.minecraft.server.v1_10_R1.IChatBaseComponent.ChatSerializer.a("{\"text\":\"" + msg + "\"}"), (byte) 2);
