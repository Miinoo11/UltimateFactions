...
import de.miinoo.factions.core.ui.gui.anvil.AnvilGUI_v1_13_R1;
...
public class FactionAdapter_v1_13_R1 extends FactionsAdapter {

    @Override
    public AnvilUI createAnvilUI(Player player) {
        return new AnvilGUI_v1_13_R1(player);
    }
