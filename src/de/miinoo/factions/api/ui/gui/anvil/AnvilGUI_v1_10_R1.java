...
public class AnvilGUI_v1_10_R1 implements AnvilUI {

    private Player player;
    private Inventory inventory;
    private Map<Integer, UIItem> items;

    public AnvilGUI_v1_10_R1(Player player) {
        this.player = player;
        items = new HashMap<>();
    }
    ...
    public void open() {
        ...
        ContainerAnvil container = new AnvilGUI_v1_10_R1.AnvilContainer(entityPlayer);
