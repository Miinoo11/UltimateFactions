    ...
    public RanksGUI(Player player, Faction faction) {
        ...
        if(faction.hasPermission(player.getUniqueId(), RankPermission.MANAGE_ROLES)) {
            addElement(getInventory().getSize() - 5,
                    new GUIItem(Items.createHead("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvM2VkZDIwYmU5MzUyMDk0OWU2Y2U3ODlkYzRmNDNlZmFlYjI4YzcxN2VlNmJmY2JiZTAyNzgwMTQyZjcxNiJ9fX0=")
